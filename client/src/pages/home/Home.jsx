...
import WhiteCard from "../../components/card/Card";
            ...
            <Row className="row-2">
              <Col md={6}>
                <p className="white-text">
                  The transparency and immutability of blockchain helps TaxChain
                  achieve its aim. We have shifted all tax related transactions
                  to blockchain due to which every single transaction taking
                  place in the complete chain is visible to evey person of the
                  country making it easier for general public to keep track of
              ...
              <Col md={6} className="icon-container">
                <FontAwesomeIcon className="icon-big" icon={faDiceD20} />
              </Col>
            </Row>
          </Container>
        </div>
